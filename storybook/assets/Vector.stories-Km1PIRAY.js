import{V as s,E as n}from"./Entity-B0ghRy1b.js";import{Default as m}from"./Layer.stories-CFR4c16K.js";import{B as p}from"./Billboard-B-f3foAU.js";import{R as e}from"./index-D4lIrffr.js";import{a as c,G as i}from"./Globe-BObO7Ybd.js";import"./v4-CtRu48qb.js";const E={title:"Components/Layer/Vector",component:s},t={parameters:{actions:{depth:1,maxDepth:1}},argTypes:{...m.argTypes},args:{name:"test",opacity:1},render:l=>e.createElement(c,null,e.createElement(i,null,e.createElement(s,{...l},e.createElement(n,{name:"Custom Entity",lon:0,lat:0,alt:0},e.createElement(p,{size:[96,96],color:"#ff5959",src:"https://sandbox.openglobus.org/examples/billboards/carrot.png"})))))};var r,o,a;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  parameters: {
    actions: {
      depth: 1,
      maxDepth: 1
