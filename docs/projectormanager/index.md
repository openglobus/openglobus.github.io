...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L130" sourceLabel="ProjectorManager.ts:130" />
...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L155" sourceLabel="ProjectorManager.ts:155" />
...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L242" sourceLabel="ProjectorManager.ts:242" />
...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L324" sourceLabel="ProjectorManager.ts:324" />
...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L386" sourceLabel="ProjectorManager.ts:386" />

Lazily allocates the manager-owned TEXTURE\_2D\_ARRAY at the size of the first projector to be added. Returns false if a size mismatch is detected.

## Instance Fields

<MemberHeading id="activecount" depth="3" name="activeCount" sig="activeCount" />

<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L66" sourceLabel="ProjectorManager.ts:66" />
...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L71" sourceLabel="ProjectorManager.ts:71" />
...
<MemberMeta sourceHref="/source/renderer/projectors/projectormanager-ts/#L76" sourceLabel="ProjectorManager.ts:76" />
