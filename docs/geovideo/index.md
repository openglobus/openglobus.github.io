...
kind: class
longname: GeoVideo
description: Used to load and display a video stream by specific corners coordinates on the globe.
---
...
<SourceLink href="/source/layer/geovideo-ts/#L15" label="GeoVideo.ts:15" />
...
<Signature code="new GeoVideo(name, options): GeoVideo" />
...
<MemberMeta sourceHref="/source/layer/geovideo-ts/#L49" sourceLabel="GeoVideo.ts:49" />
...
<MemberHeading id="setvideoelement" depth="3" name="setVideoElement" sig="setVideoElement(video: HTMLVideoElement)" />

<MemberMeta sourceHref="/source/layer/geovideo-ts/#L60" sourceLabel="GeoVideo.ts:60" />

Sets HTML5 video object.

**Parameters**

- `video` (HTMLVideoElement) — HTML5 video element object.

<MemberHeading id="setvisibility" depth="3" name="setVisibility" sig="setVisibility(visibility: boolean)" />

<MemberMeta sourceHref="/source/layer/geovideo-ts/#L72" sourceLabel="GeoVideo.ts:72" />

**Overrides:&#x20;**`BaseGeoImage#setVisibility`
...
<MemberMeta badges="abstract,protected" sourceHref="/source/layer/geovideo-ts/#L92" sourceLabel="GeoVideo.ts:92" />
...
<MemberMeta sourceHref="/source/layer/geovideo-ts/#L140" sourceLabel="GeoVideo.ts:140" />
...
<MemberMeta badges="abstract" sourceHref="/source/layer/geovideo-ts/#L179" sourceLabel="GeoVideo.ts:179" />
